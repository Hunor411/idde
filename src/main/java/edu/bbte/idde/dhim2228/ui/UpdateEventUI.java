...
public class UpdateEventUI extends JFrame {
    ...
    public UpdateEventUI(EventService eventService, EventManagerUI parentUI, Long eventId, String eventName, String eventLocation, String eventDate, boolean isOnline) {
        ...
        saveButton.addActionListener(e -> {
            ...
            try {
                ...
                EventModel updatedEvent = new EventModel(name, location, date, online);
